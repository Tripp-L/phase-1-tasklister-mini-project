document.addEventListener("DOMContentLoaded", () => {
  ...
  //user needs to interact with page to submit form, therefore we need an addEventListener
  ...
  //new-task-description... '-' is a reserved character (subtraction), therefore we need to use bracket notation for this object 
